        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20">
            <div className="flex items-center">
              <Link to="/" className="flex items-center space-x-3 group px-4 py-1.5 bg-white/50 backdrop-blur-md rounded-full shadow-sm hover:shadow-md transition-all border border-slate-100">
                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#f43f5e] via-[#eab308] to-[#0ea5e9] flex items-center justify-center text-white font-bold text-lg">
                  <Car className="w-4 h-4 flex-shrink-0"/>
                </div>
                <span className="text-xl font-extrabold tracking-tight text-slate-800 uppercase" style={{ letterSpacing: '0.05em' }}>Agent<span className="font-light">Rentals</span></span>
              </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-slate-400">
                <li><Link to="/search" className="hover:text-emerald-400 transition-colors">Browse Vehicles</Link></li>
                ...
                <li><a href="#" className="hover:text-emerald-400 transition-colors">Safety & Trust</a></li>
              </ul>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-4 text-white">For Vendors</h3>
              <ul className="space-y-3 text-sm text-slate-400">
                <li><Link to="/vendor" className="hover:text-emerald-400 transition-colors">List Your Vehicle</Link></li>
                <li><a href="#" className="hover:text-emerald-400 transition-colors">Vendor Resources</a></li>
